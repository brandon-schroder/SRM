...
class CoupledSolver:
    ...
    def _sync_geometry(self):
        ...
        A_propellant = self.ls.state.A_propellant
        A_casing = self.ls.state.A_casing

        # Update IB Geometry
        self.ib.set_geometry(x, A, P, P_wetted, A_propellant, A_casing)
    ...
    def step(self):
        ...
        self.ls.state.br = self.ls.set_burn_rate(self.ib.grid.cart_coords[0], self.ib.state.br)
